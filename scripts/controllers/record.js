...
recorderApp.controller('RecorderController', ['$scope', '$sce', '$timeout', function ($scope, $sce, $timeout) {
  ...
  $scope.input = null;
  $scope.node = null;
  $scope.samplerate = audioCtx.sampleRate;
  ...
  $scope.printTime = '';
  $scope.limit = 600000; //limit recording to 10 min
  ...
  $scope.startRecording = function () {
    ...
    function updateTime() {
      ...
      $scope.time >= $scope.limit && $scope.stopRecording();
    }
